...
(function () {
    ...
    function rezka2Mirror() {
        ...
        if (!url || /^(https?:\/\/)?kvk\.zone\/?$/i.test(url)) return 'https://rezka.fi';
    ...
    function component(object) {
        ...
        /**
         * Show the selected filter values
         */
        ...
        /**
         * Show an empty result for the keyword
         */
        ...
        /**
         * Start file navigation
         */


        this.start = function (first_select) {
            if (Lampa.Activity.active().activity !== this.activity) return; // Required to prevent an activity from being created without starting while the component loads and starts itself.
    ...
    function initMain() {
        // Register a placeholder to prevent Lampa from reporting an empty component at startup
        Lampa.Component.add('online_mod', component); // Same placeholder registration
